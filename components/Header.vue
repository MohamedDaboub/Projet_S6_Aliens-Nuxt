    ...
    <div class="flex flex-wrap justify-between items-center p-2">
      ...
      <nav class="hidden md:flex items-center">
        <ul class="flex space-x-2">
          <li>
            <router-link to="/" class="text-white   focus:ring-4 focus:ring-primary-300 font-bold rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none" aria-current="page">Home</router-link>
          </li>
          <li>
            <router-link to="/aliens" class="text-white   focus:ring-4 focus:ring-primary-300 font-bold rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Aliens</router-link>
          </li>
          <li>
            <router-link to="/aliens" class="text-white   focus:ring-4 focus:ring-primary-300 font-bold rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Aliens</router-link>
          </li>
